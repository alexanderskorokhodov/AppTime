...
class Ui_LimitsDialog(object):
    def setupUi(self, LimitsDialog):
        ...
        LimitsDialog.resize(666, 666)
        LimitsDialog.setMinimumSize(QtCore.QSize(666, 666))
        LimitsDialog.setMaximumSize(QtCore.QSize(666, 666))
        self.verticalLayoutWidget = QtWidgets.QWidget(LimitsDialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 641, 641))
        ...
        self.limitsView.header().setDefaultSectionSize(300)
        self.limitsView.header().setMinimumSectionSize(300)
